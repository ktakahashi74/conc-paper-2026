...
|--------|------------|-----------|------------------------|
| Fig. 2 | Self-Organized Polyphony | `e2/` | `paper_e2_figure_e2_1.pdf`, `paper_e2_figure_e2_2.pdf`, `paper_e2_summary.csv` |
...
| Fig. 4 | Hereditary Adaptation | `e6b/` | `paper_e6b_figure.pdf`, `paper_e6b_summary.txt`, `paper_e6b_endpoint_metrics.csv` |
