...
\section{S7. Terrain Control and Robustness Analysis (Experiment~1)}
...
We destroy spatial coherence by applying a fixed random permutation of the $C_{\text{score}}$ bin indices (generated once per run) before hill-climbing at each sweep.
