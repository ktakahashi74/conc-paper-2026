...
\textbf{Parameters:} step size $\lambda\!=\!0.15$\,st, crowding weight $\lambda_C$, $T_0\!=\!0.05$, $\tau\!=\!30$.
...
\noindent\textbf{Parameters:} $k_{\text{time}}\!=\!1.5$, $\lambda_v\!=\!1.0$, $v_{\text{floor}}\!=\!0.0$, $E_{\text{cap}}\!=\!1.0$, kick at 2\,Hz.
...
\hspace*{2em}$k_{\text{eff},i} \gets k_{\text{time}} \cdot (1 + \lambda_v \cdot g_i)$\\
