...
\smallskip
\noindent Continuous energy model: $dE_i/dt = R \cdot \max(C_{\text{field},i},\,0) - \gamma E_i$ ($R\!=\!1.0$/s, $\gamma\!=\!0.5$/s).
...
Recharge coefficient & $R$ / $r_E$ & --- & 0.5/att & 1.0/s$^\dagger$ & 0.5/att \\
Decay rate & $\gamma$ & --- & --- & 0.5/s$^\dagger$ & --- \\
...
Ratio weight & & --- & --- & --- & $1/(pq)$ \\
\bottomrule
\multicolumn{6}{@{}l}{\footnotesize $^\dagger$ Experiment 3 uses a simplified continuous energy model: $dE/dt = R\max(C_{\text{field}},0) - \gamma E$ (see S1.3).}\\
